...
class Excel_XML
{
	 ...
	 */
         ...
         * @var string
         */
        private $worksheetID = 1;
        
        
        private $worksheetsTitle = array();
        ...
        public function setWorksheetsTitle($array)
        {
        	$this->worksheetsTitle = $array;
        }
        ...
        private function addRow ($array)
        {
        	$cells = "";
                ...
                endforeach;
                $this->lines[$this->worksheetID][] = "<Row>\n" . $cells . "</Row>\n";
        }
         ...
         */
        public function addArray ($array, $worksheetID = null)
        {
        		$this->worksheetID = !empty($worksheetID) ? $worksheetID : 1;
                foreach ($array as $k => $v)
                        $this->addRow ($v);
        }
        ...
        public function generateXML ($filename = 'excel-export', $correctFilename=true)
        {
                ...
                if (is_array($this->lines) && count($this->lines)) {
                	...
                	foreach ($this->lines as $lines) {
		                ...
		                echo "\n<Worksheet ss:Name=\"" . $this->worksheetsTitle[$index] . "\">\n<Table>\n";
		                foreach ($this->lines[$index] as $line)
		                        echo $line;
